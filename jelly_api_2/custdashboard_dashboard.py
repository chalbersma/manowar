...
def api2_custdashboard_dashboard(dash_id = None, dash_name = None):
    ...
    if argument_error == False :
        ...
        meta_dict["this_cached_file"] = g.config_items["v2api"]["cachelocation"] + "/custdash_" + cache_string + ".json"


    meta_dict["NOW"] = g.NOW

    links_dict["parent"] = g.config_items["v2api"]["preroot"] + g.config_items["v2api"]["root"] + "/custdashboard/list"
    ...
    list_custdashboard_query='''select
                                ...
                                '''
    list_custdashboard_query=list_custdashboard_query + where_bits + where_clause_string
