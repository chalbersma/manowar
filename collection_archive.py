...
WHERE
last_update < FROM_UNIXTIME(%s) -  interval 7 DAY ; '''

        archive_args = [ARCHIVE_TIME]

        remove_overachieving_sql = '''
DELETE FROM collection
WHERE last_update < FROM_UNIXTIME(%s) - interval 7 DAY ; '''
        ...
        try:
            cur.execute(populate_archive_sql, archive_args)
            ...
            # Worked So Do the
            try :
                cur.execute(remove_overachieving_sql, archive_args)
